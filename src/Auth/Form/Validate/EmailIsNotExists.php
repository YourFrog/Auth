...
/**
 *  Validator sprawdzający czy adres e-mail NIE istnieje w systemie
 *
 * @package Auth\Form\Validate
 */
class EmailIsNotExists implements DoctrineEntityManagerInterface, ValidatorInterface
{
    /**
     * @var EntityManager
     */
    ...
    public function isValid($value)
    {
        ...
        return ($accountRepository->emailIsExists($value) == false);
    }
    ...
    {
        return [
            'EmailIsNotExists' => 'Podany adres e-mail jest już wykorzystywany'
        ];
    }
}